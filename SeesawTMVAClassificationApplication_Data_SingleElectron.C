...
void runSignal(std::map<std::string,int> Use, TString ifile = "./validation_Dec9.root"){
   ...
   TString prefix = "2017_TMVA_newVars";
   ...
   TFile *enddat = new TFile("/cms/mchristos/ANN/Seesaw/2016/92X/outFiles/SeesawTMVAClassificationApplicationVVV/Data/SingleElectron/QQQ/Seesaw_BDTG_Data_1.root","RECREATE");   
...
void SeesawTMVAClassificationApplication_Data_SingleElectron( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   // --------------------------------------------------------------------------------------------------
   TString dat_name = "/cms/mchristos/ANN/Seesaw/2016/92X/Data/SingleElectron/QQQ/analysisTree_3L.root";
